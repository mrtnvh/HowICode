...
Designed for styling reusable, composable components. The benefits
...
It helps to partially isolate the CSS used in the `Photo` component's
...
(Read about the [naming conventions](naming-conventions.md).)
...
```html
<article class="Excerpt u-clearfix">
